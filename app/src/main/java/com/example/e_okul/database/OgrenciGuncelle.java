...
public class OgrenciGuncelle {
    ...
    public OgrenciGuncelle(EditText nameEditText, EditText surnameEditText, EditText tcknEditText, EditText parentNameEditText, EditText noEditText) {
    ...
    public void updateData() {
        ...
        Call<String> call = apiService.updateStudent(name, surname, tc_kn, parentName, no);
            ...
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                if(response.isSuccessful() && response.body() != null) {
                    if(response.body().equals("Success")) {
                        Toast.makeText(nameEditText.getContext(), "Data updated", Toast.LENGTH_LONG).show();
                    } else {
